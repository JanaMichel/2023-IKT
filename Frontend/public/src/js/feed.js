...
function createCard(card) {
  const gridContainer = document.querySelector('.grid-container'); //anzeige der bilder als grid
  ...
  gridContainer.appendChild(cardWrapper); //hinzufügen des container zum wrapper
}
        ...
        navigator.serviceWorker.ready
            .then( sw => {
                ...
                .then( () => {
                    ...
                    let data = { message: 'Eintrag zum Synchronisieren gespeichert!', timeout: 2000};
